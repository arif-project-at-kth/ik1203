...
public class HTTPAsk {
	...
	private static final byte[] HTTP400 =
	...
	private static Map<String, Object> getTCPInformation(Socket clientSide, URL url) throws IOException {
	...
	private static URL getClientUrl(Socket clientSide) throws IOException {
		ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
		outputStream.write(fetchClientRequest(clientSide));
		return getUrl(outputStream);
	}

	private static byte[] fetchInformationFromServer(Map<String, Object> tcpInformation) throws IOException {
		try {
	...
	private static URL getUrl(ByteArrayOutputStream outputStream) throws MalformedURLException {
		String protocol = "http://";
		String[] pathAndQueryAndProtocol = outputStream.toString().split("\n")[0].split(" ");
		System.out.println(pathAndQueryAndProtocol[2]);
